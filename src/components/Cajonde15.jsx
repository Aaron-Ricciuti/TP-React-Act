...
import styles from "../../public/css/cajonde15.module.css";
...
function Cajonde15({ title, price, description, additionalInfo, socialLinks }) {
  ...
  const slides = [
        ...
        {
          image: "../../public/img/cajon_2.jpg",
          alt: "cajonde15",
        },
        {
          image: "../../public/img/cajon_3.jpg",
          alt: "cajonde15",
        },
        {
          image: "../../public/img/cajon_4.jpg",
          alt: "cajonde15",
        },
  ...
  return ( 
      ...
      {title}
        ...
        <main>
        <Carousel slides={slides} imgClass={stylesC.image} />
